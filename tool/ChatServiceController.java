...
public class ChatServiceController
{
	...
	public static String					banTime							= "1|4|24|-1";									// 国王的UID
...
//		}
		...
		int channelType = (post == MsgItem.MSG_TYPE_AUDIO ? DBDefinition.CHANNEL_TYPE_ALLIANCE : ChatServiceController
	...
	{
		JniController.getInstance().excuteJNIVoidMethod("sendRedPackage", new Object[] {""});
		try
		{
